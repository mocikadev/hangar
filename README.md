...
> Windows CLI/GUI 产物暂缓发布；`latest` 安装脚本当前仅支持 Linux/macOS。
...
┌ 账号总览 (2) ──────────────────────────────────────────────────────┐
│  账号                 状态          计划      周剩余    AT     RT │
│› alice@example.com    ● 使用中      Pro       31%       fresh  可续期│
│  bob@example.com      ★ 建议        Team      64%       fresh  可续期│
└────────────────────────────────────────────────────────────────────┘
┌ 详情 ───────────────────────────┐┌ 配额 ────────────────────────────┐
│ alice@example.com               ││ 周剩余 31% · 重置于 2026-09-27 11:41│
│ 访问令牌至 2026-10-01 21:29      ││ 重置卡 1 张                       │
└─────────────────────────────────┘└──────────────────────────────────┘
