...
当前状态：**v0.5.0 发布候选审计与 Linux/macOS/Windows CI 全绿，待创建 release tag**（可脚本化一次性 CLI、脱敏 JSON 与 TUI 配额交互已完成；GUI 冻结为维护模式并同步包版本，计划见 `docs/design/v0.5.0-cli-tui-plan.md`）
